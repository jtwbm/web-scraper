...
> За любое использование скрапера в незаконных целях вы самостоятельно несете полную юридическую ответсвенность
...
## Возможности
 ...
 - Рендер json-файлов со списком того, что вы только что собрали
